...
public class IntListTest {
    ...
    public void testSquareListRecursive() {
        ...
        IntList L =  IntList.list(3,2,1);
        IntList empty = IntList.list();
        IntList Test = IntList.squareListRecursive(L);
        assertEquals(IntList.list(9,4,1),Test);
        Test = IntList.squareListRecursive(empty);
        assertEquals(IntList.list(),Test);
