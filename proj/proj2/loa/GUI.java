...
class GUI extends TopLevel implements View, Reporter {
    ...
    GUI(String title) {
        ...
        addMenuButton("Setting->Seed", this::seed);
        addMenuButton("Setting->Limit", this::limit);
        addMenuButton("Setting->Auto Black", this::autoBlack);
        addMenuButton("Setting->Auto White", this::autoWhite);
        addMenuButton("Setting->Manual Black", this::manualBlack);
        addMenuButton("Setting->Manual White", this::manualWhite);
        addMenuButton("Help->About", this::aboutLOA);
