...
public class IntList {
    ...
    public static IntList list(Integer ... args) {
        // set a sentinel for convenience.
    ...
    public boolean equals(Object x) {
        // instanceof is a keyword that is used for checking if a
        // reference variable is containing a given type of
        // object reference or not.
        if (x instanceof IntList) {
            IntList L = (IntList) x;
            // cast: tell x that it's a IntList
            IntList p;
