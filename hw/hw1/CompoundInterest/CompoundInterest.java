...
public class CompoundInterest {
    ...
    static double futureValue(double presentValue, double rate,
                              int targetYear) {
        return presentValue*pow(1+rate/100,numYears(targetYear));
    }
    ...
    static double futureValueReal(double presentValue, double rate,
        ...
        return futureValue(presentValue,rate,targetYear)*
                pow(1-inflationRate/100,numYears(targetYear));
    }
    ...
    static double totalSavings(double perYear, int targetYear, double rate) {
        ...
        for(int i = 0; i <= numYears(targetYear); i++){
            totalSavings += futureValue(perYear,rate,targetYear-i);
        }
        return totalSavings;
    }
     ...
     *  INFLATIONRATE. */
    static double totalSavingsReal(double perYear, int targetYear,
                                   double rate, double inflationRate) {
        return totalSavings(perYear,targetYear,rate)*pow((1-inflationRate/100),numYears(targetYear));
    }
    ...
    static void printDollarFV(int targetYear, double returnRate,
        ...
        double nominalDollarValue = futureValueReal(1,
                returnRate,targetYear,inflationRate); // replace 0 with your code
        double realDollarValue = futureValueReal(1,
                returnRate,targetYear,inflationRate);    // replace 0 with your code
    ...
    static void printSavingsFV(int targetYear, double returnRate,
        ...
        double realSavings = totalSavingsReal(perYear,targetYear,
                returnRate,inflationRate);    // replace 0 with your code
        // Do not change anything in this method below this line
